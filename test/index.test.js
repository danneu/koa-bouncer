...
describe('Validator#toBoolean', () => {
  it('!!coerces val into boolean', done => {
    ...
    app.use(function(ctx) {
      ...
      ctx.body = JSON.stringify([ctx.vals.test1, ctx.vals.test2])
    })
    request(app.listen())
      .get('/')
      .expect(200)
...
describe('multiple Validator chains', () => {
  it('persists the underlying value', done => {
    ...
    app.use(function(ctx) {
      ...
      ctx.validateQuery('test').tap(n => n + 1)
...
describe('Validator#isUuid', () => {
  buildSimpleTests('isUuid', [
    ...
    [
      ...
      'all',
      200,
      'explicit all: recognizes v3',
    ],
    [
      '00000000-0000-4000-8000-000000000000',
      'all',
      200,
      'explicit all: recognizes v4',
    ],
    [
      '00000000-0000-5000-8000-000000000000',
      'all',
      200,
      'explicit all: recognizes v5',
    ],
    [
      'xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx',
      'all',
      418,
      'explicit all: recognizes non-uuid',
    ],
